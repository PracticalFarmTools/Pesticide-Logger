...
(function (root) {
  ...
  const ES = {
    ...
    'Spray window outlook — next 48 hours': 'Ventanas de aplicación — próximas 48 horas',
    'Update outlook': 'Actualizar pronóstico',
    'My location (GPS)': 'Mi ubicación (GPS)',
    ...
    'Location note': 'Nota de ubicación',
    'Permit / operator ID': 'Permiso / ID de operador',
    'Application date': 'Fecha de aplicación',
    'Start time': 'Hora de inicio',
    'End time': 'Hora de término',
    'Application time': 'Hora de aplicación',
    'What & how much': 'Qué y cuánto',
    'Product': 'Producto',
    ...
    '+ Add another product (tank mix)': '+ Agregar otro producto (mezcla)',
    'Carrier volume': 'Volumen de agua',
    'Dilution / concentration': 'Dilución / concentración',
    'Concentration': 'Concentración',
    'Mix / load location': 'Lugar de mezcla / carga',
    'Weather & drift': 'Clima y deriva',
    ...
    'Active ingredient(s)': 'Ingrediente(s) activo(s)',
    'Formulation / type': 'Formulación / tipo',
    ...
    'Size': 'Tamaño',
    'Default crop': 'Cultivo predeterminado',
    'Location / description': 'Ubicación / descripción',
