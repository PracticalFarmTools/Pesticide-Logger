...
const STATE_LAWS = {
  ...
  "DE": {
    ...
    "retentionYears": 2,
    "appliesTo": "Licensees and certified commercial applicators; each application of any pesticide. Private applicators are not named.",
    "verification": "researched",
    "notes": "EPA registration number is required for RUP or WPS-covered products. Weather (wind velocity/direction, temperature, relative humidity) is required when label directions advise drift precautions. Records logged immediately or within 24 hours unless good cause. 2026-09-24 primary-text audit: Who-clause: “(a) The Department shall require the licensee or certified commercial applicators to maintain records with respect to applications of pesticides” (3 Del. C. §1216); rule 14.1 names commercial applicators only. EPA # must be recorded at or before application for RUP or WPS-covered products; weather (wind, temperature, relative humidity) when label directions advise drift precautions.",
    "fields": [
      {
        "name": "brand_name",
        "label": "Brand / product name",
      ...
      {
        "name": "epa_reg_no",
        "label": "EPA registration number (RUP or WPS-covered products)",
        "type": "string",
        "required": false
      },
      {
        "name": "dilution_rate",
        "label": "Dilution rate (when applicable)",
        "type": "string",
        "required": false
      },
      {
      ...
      {
        "name": "wind_speed",
        "label": "Wind speed (when label advises drift precautions)",
        "type": "number",
        "required": false
      },
      {
        "name": "wind_direction",
        "label": "Wind direction (when label advises drift precautions)",
        "type": "string",
        "required": false
      },
      {
        "name": "temperature",
        "label": "Temperature (when label advises drift precautions)",
        "type": "number",
        "required": false
      },
      {
        "name": "sky",
        "label": "Relative humidity (when label advises drift precautions)",
        "type": "string",
        "required": false
      }
    ],
  ...
  "ID": {
    ...
    "verification": "researched",
    "notes": "2024/current IDAPA no longer includes dilution/rate in the main current field list, though prior/transition guidance showed dilution or rate. WPS information exchange is required when applicable before application. 2026-09-24 primary-text audit: Who-clause: rule 101 is “PROFESSIONAL APPLICATOR RECORD KEEPING REQUIREMENTS”; Idaho Code 22-3404(6) lets the director require records of professional applicators only. Customer copy: professional applicators who made an RUP application provide a copy of the records within thirty (30) days (RUP applications). Keep 2 years; no clock to make the record.",
    "fields": [
      {
        "name": "customer_name",
        "label": "Customer / person for whom applied",
      ...
      {
        "name": "supervisor_name",
        "label": "Supervising professional applicator + license # (Apprentice Category)",
        "type": "string",
        "required": false
      },
      {
        "name": "notes",
        "label": "WPS information exchange: grower contacted, date and time (if required)",
        "type": "string",
        "required": false
      },
      {
  ...
  "IL": {
    ...
    "citation": {
      ...
      "url": "https://www.ilga.gov/commission/jcar/admincode/008/008002500001500R.html"
    },
    "retentionYears": 2,
    "appliesTo": "Certified commercial applicators and operators; restricted-use pesticide applications. Illinois rules impose no private-applicator record duty.",
    "verification": "researched",
    "notes": "Rule text lists chemical name, USEPA registration number, amount of chemical concentration per unit treated, date, and use site. Illinois Extension says wind speed/direction is not required in Illinois but recommended for drift defense. WPS records can still apply to agricultural employers. JCAR 8 Ill. Adm. Code 250.150 returned 404 on 2026-08-14; Cornell LII remains the citation watch until a primary host is found. 2026-09-24 primary-text audit: Who-clause: “b) Certified commercial applicators and operators shall keep a record of all restricted pesticide usage for two (2) years.” (8 Ill. Adm. Code 250.150). No private record rule found; no clock.",
    "fields": [
      {
        "name": "brand_name",
        "label": "Brand / product name",
  ...
  "NC": {
    ...
    "citation": {
      ...
      "url": "http://reports.oah.state.nc.us/ncac/title%2002%20-%20agriculture%20and%20consumer%20services/chapter%2009%20-%20food%20and%20drug%20protection/subchapter%20l/02%20ncac%2009l%20.1402.html"
    },
    "retentionYears": 3,
    "appliesTo": "Licensed pesticide applicators and public operators as defined in G.S. 143-460 using ground equipment; restricted-use applications. Records within 72 hours, kept 3 years. Growers applying on their own or employer's land are excluded.",
    "verification": "researched",
    "notes": "Amount may be formulation or active ingredient per unit of measure. Each day of application is a separate record. Weather is not required by this rule. 2026-09-24 primary-text audit: Who-clause: 02 NCAC 09L .1402 applies to “pesticide applicators, as defined in G.S. 143-460”, which “does not include: a. Any person who uses or supervises the use of a pesticide (i) only for the purpose of producing an agricultural commodity on property owned or rented by him or his employer”. The aerial rule .1002(c) binds all agricultural aircraft operations separately.",
    "fields": [
      {
        "name": "applicator_name",
        "label": "Applicator name",
      ...
      {
        "name": "end_time",
        "label": "Time the application was completed",
        "type": "time",
        "required": true
      },
      {
        "name": "rate",
        "label": "Amount of formulation or AI per unit (acre, 1,000 sq ft)",
        "type": "string",
        "required": true
      },
      {
        "name": "noncertified_applicator_name",
        "label": "Other person(s) applying",
        "type": "string",
        "required": false
      }
    ],
  ...
  "ND": {
    ...
    "fields": [
      ...
      {
        "name": "wind_direction",
        "label": "Wind direction (outdoor; not seed treatment or bait)",
        "type": "string",
        "required": true,
        "classes": [
          "commercial"
      ...
      {
        "name": "wind_speed",
        "label": "Wind speed (outdoor; not seed treatment or bait)",
        "type": "number",
        "required": true,
        "classes": [
          "commercial"
      ...
      {
        "name": "temperature",
        "label": "Temperature (outdoor; not seed treatment or bait)",
        "type": "number",
        "required": true,
        "classes": [
          "commercial"
  ...
  "SD": {
    ...
    "fields": [
      ...
      {
        "name": "active_ingredient",
        "label": "Common name of the pesticide",
        "type": "string",
        "required": true
      }
    ],
  ...
  "TN": {
    ...
    "citation": {
      ...
      "url": "https://publications.tnsosfiles.com/rules/0080/0080-09/0080-09-04.20211226.pdf"
    },
    "retentionYears": 2,
    ...
    "verification": "researched",
    "notes": "For RUPs, EPA registration number and time of application are required. Applicators must supply required records within 48 hours of request by owner/tenant. publications.tnsosfiles.com 0080-09-04 returned AccessDenied on 2026-08-14; Cornell LII remains the citation watch until a primary host is found. 2026-09-24 primary-text audit: R6 scope quote: “(2) Private applicators shall maintain records for each application of restricted use pesticide that they apply or authorize by direct supervision.” General-use private sprays keep the core boxes. Every private record is an RUP record, so EPA # and time are required for private. Commercial RUP records also need them. Any applicator supplies a copy within 48 hours of a request by the property owner or tenant (on request). No clock to make the record.",
    "fields": [
      {
        "name": "applicator_name",
        "label": "Applicator name",
  ...
  "UT": {
    ...
    "citation": {
      "reference": "Utah Admin. Code R68-7-11(11), -12(8), -13(8)",
      "url": "https://adminrules.utah.gov/public/rule/R68-7/Current%20Rules"
    },
    "retentionYears": 2,
    "appliesTo": "Commercial applicators: any pesticide application; non-commercial applicators: restricted-use applications; private applicators: every restricted-use application and any application required by WPS (R68-7-13(8)).",
    "verification": "researched",
    "notes": "Records created within 24 hours and kept in uniform format. Commercial records require business address and commercial applicator license number; noncommercial/private rules are similar but scope differs. adminrules.utah.gov R68-7 returned 404 on 2026-08-14; Cornell LII remains the citation watch until a primary host is found. 2026-09-24 primary-text audit: Private scope: “Private pesticide applicators shall keep and maintain records of any restricted use pesticide applications, and of any pesticide applications required by WPS.” WPS reaches most farm employers, so the full private list stays.",
    "fields": [
      {
        "name": "customer_name",
        "label": "Customer / person for whom applied",
      ...
      {
        "name": "noncertified_applicator_name",
        "label": "Person applying under R68-7-13(1)(a) exemptions",
        "type": "string",
        "required": true,
        "classes": [
          "private"
  ...
  "WV": {
    ...
    "citation": {
      ...
      "url": "https://apps.sos.wv.gov/adlaw/csr/ruleview.aspx?document=17917"
    },
    "retentionYears": 2,
    ...
    "verification": "researched",
    "notes": "Private RUP records include certified and noncertified applicator names/certification numbers and records required for noncertified applicator supervision. Weather is not required by cited sections. 2026-09-24 primary-text audit: R6 scope quote: “9.3. Private Applicator - A private applicator shall keep records for a period of two years detailing the use of RUPs [§3.5: restricted use pesticides].” General-use private sprays keep the core boxes. 61CSR12A §9 and 61CSR12B §7 set no clock to make the record.",
    "fields": [
      {
        "name": "brand_name",
        "label": "Brand / product name",
