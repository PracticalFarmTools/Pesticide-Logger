...
(function (root) {
  ...
  const ES = {
    ...
    'Spray windows by field': 'Ventanas de aplicación por campo',
    'Update outlook': 'Actualizar pronóstico',
    'All fields (planning)': 'Todos los campos (planificar)',
    'This device (not a field)': 'Este dispositivo (no es un campo)',
