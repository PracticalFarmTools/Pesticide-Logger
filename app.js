/* Pesticide Logger v2.5.2 — Practical Farm Tools
...
(function () {
  ...
  function printCalcWorksheet() {
    ...
    $('#print-area').innerHTML = `
      ...
      <p class="print-meta">${esc(s.farmName || '')} · Prepared ${now().toLocaleString()} · Pesticide Logger v2.5.2 (Practical Farm Tools)</p>
      <table>
  ...
  function printReport() {
    ...
    $('#print-area').innerHTML = `
      ...
      <p class="print-footer">
        Generated by Pesticide Logger v2.5.2 — Practical Farm Tools. Retain records per your state
  ...
  function downloadStatePack() {
    ...
    const pack = {
      ...
      app: 'Pesticide Logger v2.5.2 — Practical Farm Tools',
